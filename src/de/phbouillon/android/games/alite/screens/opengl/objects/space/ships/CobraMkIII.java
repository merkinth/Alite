...
public class CobraMkIII extends SpaceObject {
    ...
    private CobraMkIII(Alite alite, ObjectType type) {
		super(alite, "Cobra Mk III", type);
		setName(R.string.so_cobra_mk_iii);
    ...
    public static SpaceObject createCobraMkIIIAsEnemy(Alite alite) {
		return new CobraMkIII(alite, ObjectType.EnemyShip);
	}
	...
	private void writeObject(ObjectOutputStream out)
		...
		try {
			...
			AliteLog.e("PersistenceException", "Cobra Mk III " + getId(), e);
			throw e;
		}
    }
