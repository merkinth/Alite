...
public class ColorSchemeTest {
	...
	public void setColorScheme() {
		...
		assertEquals(AliteColor.RED,ColorScheme.get(0,0));

		// Different kind of correct lines
		assertNull(ColorScheme.setColorScheme(null, "{\n\"colors\": {\n\"ConditionGreen\": {\n" +
			"\"startColor\": \"Red\",\n\"endColor\": \"#ffff0000\"\n}\n}\n}\n", ""));
		assertEquals(AliteColor.RED,ColorScheme.get(0,1));
		assertEquals(0xffff0000,ColorScheme.get(0,0));

		// Different kind of correct lines
		assertNull(ColorScheme.setColorScheme(null, "{\n\"colors\": {\n\"ConditionGreen\": \"red\"\n}\n}\n", ""));
		assertEquals(AliteColor.RED,ColorScheme.get(0));
		...
		try(FileInputStream fin = new FileInputStream(file)) {
			...
			assertEquals(AliteColor.RED,ColorScheme.get(ColorScheme.COLOR_ENERGY_BANK_WHOLE,0));
		} catch (IOException e){
			e.printStackTrace();
		}
	}
	...
	public void get() {
		...
		assertEquals("Should be invalid", AliteColor.TRANSPARENT, ColorScheme.get(-1));
		assertEquals("Should be invalid", AliteColor.TRANSPARENT, ColorScheme.get(1000));
		...
		assertEquals(AliteColor.MAGENTA, ColorScheme.get(ColorScheme.COLOR_ENERGY_BANK_X+3, 1));
		assertEquals(AliteColor.RED, ColorScheme.get(ColorScheme.COLOR_ENERGY_BANK_X+3, 0));
